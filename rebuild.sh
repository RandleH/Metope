...
cmake -DCMAKE_BUILD_TYPE=Debug -DCHIP=STM32F411CEU6 -DUSE_REGISTER=1 -DINCLUDE_TB_OS=1  ..
# cmake -DCMAKE_BUILD_TYPE=Debug -DCHIP=STM32F411CEU6 -DTEST_ONLY=1 -DUSE_REGISTER=1 -DINCLUDE_TB_OS=1  ..
# cmake -DCMAKE_BUILD_TYPE=Debug -DCHIP=STM32F411CEU6 -DTEST_ONLY=1 -DUSE_REGISTER=1 -DINCLUDE_TB_HMI=1 ..
